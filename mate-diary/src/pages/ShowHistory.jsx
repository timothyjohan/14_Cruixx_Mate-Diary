...
export default function ShowHistory() {
    ...
    return (
        ...
        <div className="items-center justify-center">
            ...
            <div>
                <h1 className="text-xl mb-4 font-bold">ONGOING</h1>
        ...
        {
            history.filter(data => data.status === "BEFORE" || data.status === "ONGOING").map((data, index) => (
        ...
        <h1 className="text-xl mb-4 mt-12 font-bold">HISTORY</h1>
        <div className="mb-44">
