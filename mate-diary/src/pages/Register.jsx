                    ...
                    <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                        ...
                        <form onSubmit={handleSubmit(signUp)}>
                            <div className="my-3">
                                ...
                                <input {...register("email")} type="email" name="email" id="email" class="text-white bg-gray-50 border border-gray-300 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="youremail@mail.com" required="" />
                            </div>
                            <div className="my-3">
                            ...
                            <div className="my-3">
                                ...
                                <input {...register("nickname")} type="text" name="nickname" id="nickname" class="text-white bg-gray-50 border border-gray-300 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Your Nickname" required="" />
                            </div>
                            <div className="my-3">
                            ...
                            <div className="my-3">
                                ...
                                <input {...register("company_name")} type="text" name="company_name" id="company_name" class="text-white bg-gray-50 border border-gray-300 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Your Company Name" required="" />
                            </div>
                            ...
                            <div className="my-3">
                                ...
                                <button type="submit" class="w-full mt-2 text-white bg-black hover:bg-black-700 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">Sign up</button>
